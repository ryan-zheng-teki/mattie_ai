...
import { elements, quizQuestions, SHELL_COLORS, ELEMENT_DESCRIPTIONS } from './elements-data.js';
...
export function onElementChange(event) {
    ...
    updateVisualization(selectedElement);
}
...
export function updateElementInfo(element) {
